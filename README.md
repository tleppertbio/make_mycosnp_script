...
See [pathogentotree suite](https://github.com/tleppertbio/pathogentotree/pathogentotree.README.md) invokes the docker container tleppertwood/pathogentotree:latest.
...
6) [after this program](https://github.com/tleppertbio/pathogentotree/pathogentotree.README.md#running-invokemycosnpscriptpy) script that is to be run after make_mycosnp_script.py
